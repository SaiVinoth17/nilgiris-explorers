      ...
      <div className="container-default max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-emerald max-w-none text-white/70">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              Welcome to Nilgiris Explorers. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>To process and manage your tour/cab booking.</li>
          ...
          <section>
            ...
            <p>
              ...
              <strong>Email:</strong> privacy@nilgirisexplorers.com<br/>
              <strong>Phone:</strong> +91 95852 19509
            </p>
          </section>
        </div>
      </div>
