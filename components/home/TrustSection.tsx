    ...
    <section className="section-pad section-forest border-y border-[#00D26A]/10">
      <div className="container-default">
        ...
        <motion.div
          ...
          className="glass-card rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-8 border border-[#00D26A]/20 bg-gradient-to-r from-white/5 to-[#00D26A]/5"
        >
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <div className="text-white font-bold text-lg">4.9 / 5.0 Rating</div>
              <div className="text-white/50 text-sm">Based on 1,240+ Verified Google Reviews</div>
            </div>
          </div>
          
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl text-sm font-semibold text-white">
              <ShieldCheck className="w-5 h-5 text-blue-400" /> SSL Secured
            </div>
            <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl text-sm font-semibold text-white">
              <Users className="w-5 h-5 text-emerald-400" /> Govt. Approved Natives
            </div>
            <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl text-sm font-semibold text-white">
              <Clock className="w-5 h-5 text-amber-400" /> 15+ Years Expertise
            </div>
          </div>
        </motion.div>
      </div>
